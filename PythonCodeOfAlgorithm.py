...
def randomforest():
    if len(NameEn.get()) == 0:
        ...
        if (h == 'yes'):
            ...
            pred2.set(" ")
            pred2.set("Not Found")
#created database if not exists named as database.db
        import sqlite3
        conn = sqlite3.connect('database.db')
        c = conn.cursor()
        c.execute(
...
w2 = Label(root, justify=LEFT, text="Disease Prediction and Analysis", fg="Darkblue", bg="Pink")
w2.config(font=("Times", 30, "bold italic"))
w2.grid(row=1, column=0, columnspan=2, padx=100)
# w2 = Label(root, justify=LEFT, text="Contributors: Gulsimar, Deepak", fg="DarkRed", bg="Pink")
w2.config(font=("Times", 20, "bold italic"))
w2.grid(row=2, column=0, columnspan=2, padx=100)

# Label for the name
NameLb = Label(root, text="Name of the Patient", fg="Purple", bg="Pink")
NameLb.config(font=("Times", 15, "bold italic"))
NameLb.grid(row=6, column=0, pady=15, sticky=W)

# Creating Labels for the symtoms
S1Lb = Label(root, text="Symptom 1", fg="Black", bg="Pink")
S1Lb.config(font=("Times", 15, "bold italic"))
S1Lb.grid(row=7, column=0, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2", fg="Black", bg="Pink")
S2Lb.config(font=("Times", 15, "bold italic"))
S2Lb.grid(row=8, column=0, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3", fg="Black", bg="Pink")
...
S5Lb = Label(root, text="Symptom 5", fg="Black", bg="Pink")
S5Lb.config(font=("Times", 15, "bold italic"))
S5Lb.grid(row=11, column=0, pady=10, sticky=W)

# Labels for the different algorithms
lrLb = Label(root, text="DecisionTree", fg="white", bg="IndianRed", width=20)
lrLb.config(font=("Times", 15, "bold italic"))
lrLb.grid(row=15, column=0, pady=10, sticky=W)

destreeLb = Label(root, text="RandomForest", fg="white", bg="IndianRed", width=20)
destreeLb.config(font=("Times", 15, "bold italic"))
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes", fg="White", bg="IndianRed", width=20)
ranfLb.config(font=("Times", 15, "bold italic"))
ranfLb.grid(row=19, column=0, pady=10, sticky=W)

knnLb = Label(root, text="kNearestNeighbour", fg="white", bg="IndianRed", width=20)
...
dst = Button(root, text="Prediction 1", command=DecisionTree, bg="LightCoral", fg="white")
dst.config(font=("Times", 15, "bold italic"))
dst.grid(row=6, column=3, padx=10)

rnf = Button(root, text="Prediction 2", command=randomforest, bg="LightCoral", fg="white")
rnf.config(font=("Times", 15, "bold italic"))
rnf.grid(row=7, column=3, padx=10)

lr = Button(root, text="Prediction 3", command=NaiveBayes, bg="LightCoral", fg="white")
lr.config(font=("Times", 15, "bold italic"))
lr.grid(row=8, column=3, padx=10)

kn = Button(root, text="Prediction 4", command=KNN, bg="LightCoral", fg="white")
kn.config(font=("Times", 15, "bold italic"))
kn.grid(row=9, column=3, padx=10)

rs = Button(root, text="Reset Inputs", command=Reset, bg="Khaki", fg="purple", width=15)
rs.config(font=("Times", 15, "bold italic"))
rs.grid(row=10, column=3, padx=10)

ex = Button(root, text="Exit System", command=Exit, bg="Khaki", fg="purple", width=15)
ex.config(font=("Times", 15, "bold italic"))
ex.grid(row=11, column=3, padx=10)

# Showing the output of different algorithms
t1 = Label(root, font=("Times", 15, "bold italic"), text="Decision Tree", height=1, bg="MistyRose"
           , width=40, fg="IndianRed", textvariable=pred1, relief="sunken").grid(row=15, column=1, padx=10)

t2 = Label(root, font=("Times", 15, "bold italic"), text="Random Forest", height=1, bg="MistyRose"
           , width=40, fg="IndianRed", textvariable=pred2, relief="sunken").grid(row=17, column=1, padx=10)

t3 = Label(root, font=("Times", 15, "bold italic"), text="Naive Bayes", height=1, bg="MistyRose"
           , width=40, fg="IndianRed", textvariable=pred3, relief="sunken").grid(row=19, column=1, padx=10)

t4 = Label(root, font=("Times", 15, "bold italic"), text="kNearest Neighbour", height=1, bg="MistyRose"
           , width=40, fg="IndianRed", textvariable=pred4, relief="sunken").grid(row=21, column=1, padx=10)
